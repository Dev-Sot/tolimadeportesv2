...
const POSTS = [
  ...
  { slug: '4', title: 'Asociación de Productores de Planadas: del campo al marketplace', excerpt: 'Caso de éxito de cómo productores cafeteros de Planadas diversificaron su oferta con equipamiento agrícola deportivo a través de Canchazo.', category: 'Casos de éxito', author: 'Nelson Garzón', date: '2026-04-20', img: 'https://images.unsplash.com/photo-1530610476181-d83430b64dcd?w=600', readTime: '6 min' },
