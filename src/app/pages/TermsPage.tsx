...
const SECTIONS = [
  { title: '1. Aceptación de los términos', body: 'Al acceder y usar la plataforma Canchazo (en adelante "la Plataforma"), usted acepta estar sujeto a estos Términos y Condiciones. Si no está de acuerdo con alguna parte, no podrá acceder al servicio.' },
  { title: '2. Descripción del servicio', body: 'Canchazo es una plataforma SaaS que facilita la compra y venta de equipamiento deportivo, la reserva de canchas deportivas, la inscripción a torneos y la conexión entre usuarios en el departamento del Tolima, Colombia.' },
  ...
  { title: '5. Transacciones y pagos', body: 'Los pagos se procesan a través de Wompi (Bancolombia). Canchazo actúa como intermediario y no almacena datos de tarjetas. Los precios están en pesos colombianos (COP) e incluyen IVA del 19% cuando aplique.' },
  ...
  { title: '8. Limitación de responsabilidad', body: 'Canchazo no garantiza la disponibilidad ininterrumpida del servicio. No nos hacemos responsables por daños indirectos derivados del uso de la plataforma o de transacciones entre usuarios.' },
  ...
  { title: '10. Contacto', body: 'Para preguntas sobre estos términos, contáctenos en hola@canchazo.co. Ibagué, Tolima, Colombia.' },
];
